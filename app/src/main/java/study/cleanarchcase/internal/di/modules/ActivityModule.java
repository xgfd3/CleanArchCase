...
public class ActivityModule {
  ...
  @Provides @PerActivity UserListView provideUserListView(UserListFragment userListFragment){return userListFragment;}

  @Provides @PerActivity UserDetailView provideUserDetailView(UserDetailFragment userDetailFragment){return userDetailFragment;}
}
